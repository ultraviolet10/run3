...
export const APP_ACCOUNT_ASSOCIATION: AccountAssociation | undefined = {
  header:
    "eyJmaWQiOjEyMjc2MDAsInR5cGUiOiJjdXN0b2R5Iiwia2V5IjoiMHhGMTBjZWYxMTE2ODc2RjY1MTJmZkMxMjMwMTFCMDk2NjE4OGYzMjFBIn0",
  payload: "eyJkb21haW4iOiJ3d3cuZmxpcGVtLnh5eiJ9",
  signature:
    "MHg4MWM0MjYzYmZjYzRhZThkNDBhYWU5YWNlN2ZiNmY5YmI5OWQ5OGVmZmI5M2ZhZDUwZmI4ODMxOGZlZWE4MGU0M2YwOTE3NTI0OTFlZTFiNzg2YTVjYWIwODllOTE3MjViZmFmYmEwMzgyNjU5OGViOWI5YTgwZjFjMWYzZWI5NzFj",
};
