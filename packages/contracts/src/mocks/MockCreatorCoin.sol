...
contract MockCreatorCoin is ICreatorCoin {
    ...
    function getClaimableAmount() external pure returns (uint256) { return 0; }
    function claimVesting() external pure returns (uint256) { return 0; }
    function poolManager() external pure returns (IPoolManager) { return IPoolManager(address(0)); }
    function name() external pure returns (string memory) { return "MockCreatorCoin"; }
    function symbol() external pure returns (string memory) { return "MCC"; }
